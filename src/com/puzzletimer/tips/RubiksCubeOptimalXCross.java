...
public class RubiksCubeOptimalXCross implements Tip {
    ...
    public String getTipDescription() {
        return t("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS");
    }
    ...
    public String getTip(Scramble scramble) {
        ...
        tip.append(t("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_u") + ":\n");
        tip.append(getOptimalSolutions(stateU, "x2 "));
        tip.append("\n");

        // x-cross on D
        State stateD = state;
        tip.append(t("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_d") + ":\n");
        ...
        tip.append(t("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_l") + ":\n");
        ...
        tip.append(t("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_r") + ":\n");
        ...
        tip.append(t("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_f") + ":\n");
        ...
        tip.append(t("tip.RUBIKS-CUBE-OPTIMAL-X-CROSS.optimal_x_cross_on_b") + ":\n");
