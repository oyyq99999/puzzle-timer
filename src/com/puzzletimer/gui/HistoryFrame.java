...
public class HistoryFrame extends JFrame {
    private static class SolutionImporterDialog extends JDialog {
        ...
        public SolutionImporterDialog(
            ...
            setTitle(t("solution_importer.solution_importer"));
        ...
        private void createComponents() {
            ...
            // labelSolutions
            add(new JLabel(t("solution_importer.solutions")), "wrap");

            // textAreaContents
            this.textAreaContents = new JTextArea(t("solution_importer.default_contents"));
            JScrollPane scrollPane = new JScrollPane(this.textAreaContents);
            add(scrollPane, "growx, wrap");

            // buttonOk
            this.buttonOk = new JButton(t("solution_importer.ok"));
            add(this.buttonOk, "right, width 100, span 2, split");

            // buttonCancel
            this.buttonCancel = new JButton(t("solution_importer.cancel"));
            ...
            public void actionPerformed(ActionEvent e) {
                if (HistoryFrame.this.table.getSelectedRows().length > 5) {
                    int result = JOptionPane.showConfirmDialog(
                        HistoryFrame.this,
                        t("history.solution_removal_confirmation_message"),
                        t("history.remove_solutions"),
    ...
    private void createComponents() {
        ...
        // labelHistogram
        add(new JLabel(t("history.histogram")), "span, wrap");
        ...
        // labelGraph
        add(new JLabel(t("history.graph")), "span, wrap");
        ...
        // labelStatistics
        add(new JLabel(t("history.statistics")), "span, wrap");
        ...
        // buttonAddSolutions
        this.buttonAddSolutions = new JButton(t("history.add_solutions"));
        add(this.buttonAddSolutions, "growx, top, split 5, flowy");

        // buttonEdit
        this.buttonEdit = new JButton(t("history.edit"));
        this.buttonEdit.setEnabled(false);
        add(this.buttonEdit, "growx, top");

        // buttonRemove
        this.buttonRemove = new JButton(t("history.remove"));
        this.buttonRemove.setEnabled(false);
        add(this.buttonRemove, "growx, top");

        // buttonSelectSession
        this.buttonSelectSession = new JButton(t("history.select_session"));
        add(this.buttonSelectSession, "growx, top, gaptop 16");

        // buttonSelectNone
        this.buttonSelectNone = new JButton(t("history.select_none"));
        add(this.buttonSelectNone, "growx, top, wrap");

        // buttonOk
        this.buttonOk = new JButton(t("history.ok"));
    ...
    private void updateTable(Solution[] solutions) {
        ...
        tableModel.addColumn(t("history.#"));
        tableModel.addColumn(t("history.start"));
        tableModel.addColumn(t("history.time"));
        tableModel.addColumn(t("history.penalty"));
        tableModel.addColumn(t("history.scramble"));
