...
public class MainFrame extends JFrame {
    ...
    public MainFrame(
        ...
        this.categoryManager.addListener(new CategoryManager.Listener() {
            ...
            public void categoriesUpdated(Category[] categories, Category currentCategory) {
                setTitle(
                    String.format(
                        t("main.prisma_puzzle_time_category"),
        ...
        this.menuItemAddSolution.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                solutionEditingDialog.setTitle(t("main.add_solution_title"));
        ...
        this.categoryManager.addListener(new CategoryManager.Listener() {
            ...
            public void categoriesUpdated(Category[] categories, Category currentCategory) {
                ...
                // category manager
                JMenuItem menuItemCategoryManager = new JMenuItem(t("main.category_manager"));
            ...
            if (this.mixerInfo != null) {
                ...
                try {
                    ...
                    MainFrame.this.messageManager.enqueueMessage(
                        MessageType.ERROR,
                        t("main.stackmat_timer_error_message"));
                }
            } else {
                // select the default timer
                this.menuItemSpaceKey.setSelected(true);
    ...
    private void createComponents() {
        ...
        // menuFile
        this.menuFile = new JMenu(t("main.file"));
        this.menuFile.setMnemonic(KeyEvent.VK_F);
        menuBar.add(this.menuFile);

        // menuItemAddSolution
        this.menuItemAddSolution = new JMenuItem(t("main.add_solution"));
        ...
        // menuItemExit
        this.menuItemExit = new JMenuItem(t("main.exit"));
        this.menuItemExit.setMnemonic(KeyEvent.VK_X);
        this.menuFile.add(this.menuItemExit);

        // menuView
        JMenu menuView = new JMenu(t("main.view"));
        menuView.setMnemonic(KeyEvent.VK_V);
        menuBar.add(menuView);

        // menuItemTips
        this.menuItemTips = new JMenuItem(t("main.tips"));
        ...
        // menuItemScrambleQueue
        this.menuItemScrambleQueue = new JMenuItem(t("main.scramble_queue"));
        ...
        // menuItemHistory
        this.menuItemHistory = new JMenuItem(t("main.history"));
        ...
        // menuItemSessionSummary
        this.menuItemSessionSummary = new JMenuItem(t("main.session_summary"));
        ...
        // menuCategory
        this.menuCategory = new JMenu(t("main.category"));
        this.menuCategory.setMnemonic(KeyEvent.VK_C);
        menuBar.add(this.menuCategory);

        // menuOptions
        JMenu menuOptions = new JMenu(t("main.options"));
        menuOptions.setMnemonic(KeyEvent.VK_O);
        menuBar.add(menuOptions);

        // menuColorScheme
        this.menuItemColorScheme = new JMenuItem(t("main.color_scheme"));
        ...
        // menuItemInspectionTime
        this.menuItemInspectionTime = new JCheckBoxMenuItem(t("main.inspection_time"));
        ...
        // menuItemSpaceKey
        this.menuItemSpaceKey = new JRadioButtonMenuItem(t("main.space_key"));
        ...
        // menuItemStackmatTimer
        this.menuItemStackmatTimer = new JRadioButtonMenuItem(t("main.stackmat_timer"));
        ...
        this.stackmatTimerInputDevice = new JMenu(t("main.stackmat_timer_input_device"));
        ...
        //menuHelp
        JMenu menuHelp = new JMenu(t("main.help"));
        menuHelp.setMnemonic(KeyEvent.VK_H);
        menuBar.add(menuHelp);

        // menuItemAbout
        this.menuItemAbout = new JMenuItem(t("main.about"));
        ...
        this.timesScrollPane.setBorder(BorderFactory.createTitledBorder(t("main.times")));
        ...
        this.statisticsPanel.setBorder(BorderFactory.createTitledBorder(t("main.session_statistics")));
        ...
        this.scrambleViewerPanel.setBorder(BorderFactory.createTitledBorder(t("main.scramble")));
