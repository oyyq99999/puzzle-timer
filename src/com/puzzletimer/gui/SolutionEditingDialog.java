...
public class SolutionEditingDialog extends JDialog {
    ...
    public SolutionEditingDialog(
        ...
        setTitle(t("solution_editing.solution_editor"));
    ...
    private void createComponents() {
        ...
        // labelStart
        add(new JLabel(t("solution_editing.start")));
        ...
        // labelTime
        add(new JLabel(t("solution_editing.time")));
        ...
        // labelScramble
        add(new JLabel(t("solution_editing.scramble")));
        ...
        // buttonOk
        this.buttonOk = new JButton(t("solution_editing.ok"));
        add(this.buttonOk, "tag ok, span 2, split");

        // buttonCancel
        this.buttonCancel = new JButton(t("solution_editing.cancel"));
