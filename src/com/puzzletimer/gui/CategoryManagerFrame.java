...
class CategoryEditorDialog extends JDialog {
    ...
    public CategoryEditorDialog(
        ...
        setTitle(t("category_editor.category_editor"));
    ...
    private void createComponents() {
        ...
        add(new JLabel(t("category_editor.description")));
        ...
        // buttonAdd
        this.buttonAdd = new JButton(t("category_editor.add"));
        ...
        // buttonUp
        this.buttonUp = new JButton(t("category_editor.up"));
        add(this.buttonUp, "sizegroup button, top, split 3, flowy");

        // buttonDown
        this.buttonDown = new JButton(t("category_editor.down"));
        add(this.buttonDown, "sizegroup button");

        // buttonRemove
        this.buttonRemove = new JButton(t("category_editor.remove"));
        add(this.buttonRemove, "sizegroup button, wrap");

        // buttonOk
        this.buttonOk = new JButton(t("category_editor.ok"));
        add(this.buttonOk, "tag ok, span 3, split");

        // buttonCancel
        this.buttonCancel = new JButton(t("category_editor.cancel"));
...
public class CategoryManagerFrame extends JFrame {
    ...
    public CategoryManagerFrame(
        ...
        setTitle(t("category_manager.category_manager"));
        ...
        categoryManager.addListener(new CategoryManager.Listener() {
            ...
            public void categoriesUpdated(Category[] categories, Category currentCategory) {
                ...
                tableModel.addColumn(t("category_manager.description"));
                tableModel.addColumn(t("category_manager.puzzle"));
                tableModel.addColumn(t("category_manager.scrambler"));
        ...
        this.buttonAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                Category category = new Category(
                    UUID.randomUUID(),
                    "RUBIKS-CUBE-RANDOM",
                    t("category_manager.new_category"),
                    true,
                    new String[0]);
        ...
        this.buttonRemove.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                int result = JOptionPane.showConfirmDialog(
                    CategoryManagerFrame.this,
                    t("category_manager.category_removal_confirmation_message"),
                    t("category_manager.remove_category"),
    ...
    private void createComponents() {
        ...
        // labelCategories
        JLabel labelCategories = new JLabel(t("category_manager.categories"));
        ...
        // buttonAdd
        this.buttonAdd = new JButton(t("category_manager.add"));
        add(this.buttonAdd, "top, growx, split, flowy");

        // buttonEdit
        this.buttonEdit = new JButton(t("category_manager.edit"));
        this.buttonEdit.setEnabled(false);
        add(this.buttonEdit, "growx");

        // buttonRemove
        this.buttonRemove = new JButton(t("category_manager.remove"));
        this.buttonRemove.setEnabled(false);
        add(this.buttonRemove, "growx, wrap");

        // buttonOk
        this.buttonOk = new JButton(t("category_manager.ok"));
