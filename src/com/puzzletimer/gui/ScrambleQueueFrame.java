...
public class ScrambleQueueFrame extends JFrame {
    ...
    public ScrambleQueueFrame(
        ...
        categoryManager.addListener(new CategoryManager.Listener() {
            ...
            public void categoriesUpdated(Category[] categories, Category currentCategory) {
                ...
                setTitle(
                    String.format(
                        t("scramble_queue.scramble_queue-category"),
        ...
        this.buttonImportFromFile.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                fileChooser.setFileFilter(new FileNameExtensionFilter(t("scramble_queue.scramble_file_description"), "txt"));
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(
                        ...
                        String.format(
                            t("scramble_queue.file_opening_error"),
                            fileChooser.getSelectedFile().getAbsolutePath()),
                        t("scramble_queue.error"),
        ...
        this.buttonExport.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                JFileChooser fileChooser = new JFileChooser();
                fileChooser.setSelectedFile(new File(t("scramble_queue.default_file_name")));
                fileChooser.setFileFilter(new FileNameExtensionFilter(t("scramble_queue.scramble_file_description"), "txt"));
    ...
    private void createComponents() {
        ...
        // labelQueue
        add(new JLabel(t("scramble_queue.queue")), "span, wrap");
        ...
        // buttonUp
        this.buttonUp = new JButton(t("scramble_queue.up"));
        this.buttonUp.setEnabled(false);
        add(this.buttonUp, "top, growx, split 5, flowy");

        // buttonDown
        this.buttonDown = new JButton(t("scramble_queue.down"));
        this.buttonDown.setEnabled(false);
        add(this.buttonDown, "top, growx");

        // buttonRemove
        this.buttonRemove = new JButton(t("scramble_queue.remove"));
        this.buttonRemove.setEnabled(false);
        add(this.buttonRemove, "top, growx");

        // buttonImportFromFile
        this.buttonImportFromFile = new JButton(t("scramble_queue.import_from_file"));
        add(this.buttonImportFromFile, "gaptop 20, top, growx");

        // buttonExport
        this.buttonExport = new JButton(t("scramble_queue.export_to_file"));
        ...
        this.buttonImportFromScrambler = new JButton(t("scramble_queue.import"));
        add(this.buttonImportFromScrambler, "wrap");

        // buttonOK
        this.buttonOk = new JButton(t("scramble_queue.ok"));
    ...
    private void updateTable(Scramble[] queue) {
        ...
        tableModel.addColumn(t("scramble_queue.#"));
        tableModel.addColumn(t("scramble_queue.scramble"));
