...
public class AboutDialog extends JDialog {
    public AboutDialog(JFrame owner, boolean modal) {
        ...
        setTitle(t("about.prisma_puzzle_timer_version"));
        setResizable(false);
    ...
    private void createComponents() {
        ...
        JLabel labelPrismaPuzzleTimer = new JLabel(t("about.prisma_puzzle_timer_version"));
        labelPrismaPuzzleTimer.setFont(new Font("Arial", Font.BOLD, 16));
        add(labelPrismaPuzzleTimer, "split 3, gapbottom 10, flowy");

        // labelURL
        JLabel labelURL = new JLabel(t("about.prisma_puzzle_timer_address"));
        add(labelURL);

        // labelWalter
        JLabel labelWalter = new JLabel(t("about.walters_email"));
        add(labelWalter);
    }
}
