...
public class ColorSchemeFrame extends JFrame {
    ...
    public ColorSchemeFrame(final PuzzleProvider puzzleProvider, final ColorManager colorManager) {
        ...
        setTitle(t("color_scheme.color_scheme"));
        ...
        this.buttonEdit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                Color color = JColorChooser.showDialog(
                    ...
                    String.format(t("color_scheme.face_color"), faceColor.getFaceDescription()),
                    faceColor.getColor());
                if (color != null) {
    ...
    private void createComponents() {
        ...
        // labelColors
        add(new JLabel(t("color_scheme.colors")), "growx, span, wrap");
        ...
        // buttonEdit
        this.buttonEdit = new JButton(t("color_scheme.edit"));
        add(this.buttonEdit, "growx, top, split, flowy");

        // buttonDefault
        this.buttonDefault = new JButton(t("color_scheme.default"));
        add(this.buttonDefault, "growx, top, wrap");

        // buttonOk
        this.buttonOk = new JButton(t("color_scheme.ok"));
    ...
    private void update(Puzzle puzzle, ColorScheme colorScheme) {
        ...
        tableModel.addColumn(t("color_scheme.face"));
        tableModel.addColumn(t("color_scheme.color"));
